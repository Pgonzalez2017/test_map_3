...
var lyr_3_3 = new ol.layer.Vector({
        ...
        var lyr_ESRITopo_4 = new ol.layer.Tile({
            'title': 'ESRI Topo',
            'type': 'base',
            'opacity': 1.000000,
...
lyr_OSMStandard_0.setVisible(true);lyr_1_1.setVisible(true);lyr_2_2.setVisible(true);lyr_3_3.setVisible(true);lyr_ESRITopo_4.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_1_1,lyr_2_2,lyr_3_3,lyr_ESRITopo_4];
